...
from src.entity.estimator import Refer_Pass_Model   # Ensure that CreditCardModel is defined in estimator module
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            refer_pass_model = Refer_Pass_Model(preprocessing_object=preprocessing_obj,
                                       trained_model_object=best_model_detail.best_model)
            logging.info("Created credit card model object with preprocessor and model")
            logging.info("Created best model file path.")
            save_object(self.model_trainer_config.trained_model_file_path, refer_pass_model)
